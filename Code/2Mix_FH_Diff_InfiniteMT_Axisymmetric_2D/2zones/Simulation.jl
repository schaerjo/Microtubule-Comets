...
# @inline function Binding_Zone!(h, hmax, hmin, L, Nx)
#     @cuda threads = block_dim blocks = grid_dim kernel_Binding_Zone!(h, hmax, hmin, L, Nx)
# end
...
println(" M= ", M, " a= ", a, " chi= ", χ, " k= ", k, " hmax= ", hmax, " hmin= ", hmin, " L= ", L, " pzone= ", pzone, " phi0= ", ϕ0, " R= ", R, " dx= ", dx, " dt= ", dt, " Nx= ", Nx, " Nz= ", Nz, " T= ", NΔt, " prin= ", prin)
